namespace ZData00.Exceptions
{
	...
	public class LinkException : BaseException
	{
		...
		public LinkException(Exception? ex, BlockType? btype, [CallerMemberName] string name = "", [CallerFilePath] string path = "", [CallerLineNumber] int line = 0) : base(ex, btype, ExType.Link, name, path, line) => Log.Event(new StackFrame(true));
