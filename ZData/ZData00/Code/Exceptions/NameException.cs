namespace ZData00.Exceptions
{
	...
	public class NameException : BaseException
	{
		...
		public NameException(Exception? ex, BlockType? btype, [CallerMemberName] string name = "", [CallerFilePath] string path = "", [CallerLineNumber] int line = 0) : base(ex, btype, ExType.Name, name, path, line) => Log.Event(new StackFrame(true));
