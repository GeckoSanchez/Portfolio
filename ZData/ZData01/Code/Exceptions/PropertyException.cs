namespace ZData01.Exceptions
{
	...
	public class PropertyException : BaseException
	{
		...
		public PropertyException(Exception? ex, BlockType? btype, [CallerMemberName] string name = "", [CallerFilePath] string path = "", [CallerLineNumber] int line = 0) : base(ex, btype, ExType.Property, name, path, line) => Log.Event(new StackFrame(true));
