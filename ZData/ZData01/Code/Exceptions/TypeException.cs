namespace ZData01.Exceptions
{
	...
	public class TypeException : BaseException
	{
		...
		public TypeException(Exception? ex, BlockType? btype, [CallerMemberName] string name = "", [CallerFilePath] string path = "", [CallerLineNumber] int line = 0) : base(ex, btype, ExType.Type, name, path, line) => Log.Event(new StackFrame(true));
