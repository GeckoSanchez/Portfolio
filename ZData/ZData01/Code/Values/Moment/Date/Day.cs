namespace ZData01.Values
{
	...
	public class Day : BaseNumber<int>, IMinMaxValue<Day>
	{
		public new static Day MinValue => new(DateOnly.MinValue.Day);
		public new static Day MaxValue => new(DateOnly.MaxValue.Day);
		...
		/// <inheritdoc cref="Day(uint)"/>
		public Day(Day value) : this(value.Value) => Log.Event(new StackFrame(true));

		/// <inheritdoc cref="Day(uint)"/>
		public Day(Date value) : this(value.Value.Day) => Log.Event(new StackFrame(true));

		/// <inheritdoc cref="Day(uint)"/>
		public Day(Moment value) : this(value.Value.Day) => Log.Event(new StackFrame(true));
