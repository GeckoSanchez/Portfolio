namespace ZData02.Actions
{
	...
	public static class Get
	{
		...
		[Unlogged]
		public static BlockKind BlockType(MethodBase? method)
		{
			BlockKind? Out;
			...
			return Out ?? Enums.BlockKind.Function;
		}

		/// <inheritdoc cref="BlockType(MethodBase?)"/>
		[Unlogged]
		public static BlockKind BlockType(StackFrame sf)
		{
			BlockKind? Out;
		...
		/// <inheritdoc cref="BlockType(MethodBase?)"/>
		[Unlogged]
		public static BlockKind BlockTypeOrDefault(StackFrame sf)
		{
			BlockKind? Out;
		...
		/// <inheritdoc cref="BlockType(MethodBase?)"/>
		[Unlogged]
		public static BlockKind BlockTypeOrDefault(StackFrame sf, BlockKind defaultValue)
		{
			BlockKind? Out;
