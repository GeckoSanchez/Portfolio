namespace ZData02.Exceptions
{
	...
	public class DeviceException : BaseException
	{
		...
		public DeviceException(Exception? ex, BlockKind? btype, [CallerMemberName] string name = "", [CallerFilePath] string path = "", [CallerLineNumber] int line = 0) : base(ex, btype, ExceptKind.Device, name, path, line) => Log.Event(new StackFrame(true));
