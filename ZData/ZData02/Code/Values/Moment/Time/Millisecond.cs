namespace ZData02.Values
{
	...
	public class Millisecond : LNumber<int>, IMinMaxValue<Millisecond>
	{
		public static Millisecond MinValue => new(TimeOnly.MinValue.Millisecond);
		public static Millisecond MaxValue => new(TimeOnly.MaxValue.Millisecond);
		...
		/// <inheritdoc cref="Millisecond(uint)"/>
		public Millisecond(Millisecond value) : this(value.Data) => Log.Event(new StackFrame(true));

		/// <inheritdoc cref="Millisecond(uint)"/>
		public Millisecond(Time value) : this(value.Data.Millisecond) => Log.Event(new StackFrame(true));

		/// <inheritdoc cref="Millisecond(uint)"/>
		public Millisecond(Moment value) : this(value.Data.Millisecond) => Log.Event(new StackFrame(true));
