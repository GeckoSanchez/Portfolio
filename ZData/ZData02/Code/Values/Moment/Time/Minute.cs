namespace ZData02.Values
{
	...
	public class Minute : LNumber<int>, IMinMaxValue<Minute>
	{
		public static Minute MinValue => new(TimeOnly.MinValue.Minute);
		public static Minute MaxValue => new(TimeOnly.MaxValue.Minute);
		...
		/// <inheritdoc cref="Minute(uint)"/>
		public Minute(Minute value) : this(value.Data) => Log.Event(new StackFrame(true));

		/// <inheritdoc cref="Minute(uint)"/>
		public Minute(Time value) : this(value.Data.Minute) => Log.Event(new StackFrame(true));

		/// <inheritdoc cref="Minute(uint)"/>
		public Minute(Moment value) : this(value.Data.Minute) => Log.Event(new StackFrame(true));
