namespace ZData02.Values
{
	...
	public class Second : LNumber<int>, IMinMaxValue<Second>
	{
		public static Second MinValue => new(TimeOnly.MinValue.Second);
		public static Second MaxValue => new(TimeOnly.MaxValue.Second);
		...
		/// <inheritdoc cref="Second(uint)"/>
		public Second(Second value) : this(value.Data) => Log.Event(new StackFrame(true));

		/// <inheritdoc cref="Second(uint)"/>
		public Second(Time value) : this(value.Data.Second) => Log.Event(new StackFrame(true));

		/// <inheritdoc cref="Second(uint)"/>
		public Second(Moment value) : this(value.Data.Second) => Log.Event(new StackFrame(true));
